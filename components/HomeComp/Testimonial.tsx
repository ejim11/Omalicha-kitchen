...
const Testimonial = () => {
  ...
  return (
    <section className="mt-[8rem] relative  ">
      <div className="w-[60rem] absolute  -left-[15rem] -top-[10rem]">
        <Image
          src={flowerImg3}
          alt="flower image"
          priority
      ...
      <div className="w-[55rem] absolute -bottom-[1rem] -right-[16rem]">
        <Image
          src={flowerImg4}
          alt="flower image"
          priority
          ...
          {testimonials.map((testimonial) => (
            <div key={testimonial.customerName} className="px-[2rem]">
              <div className="flex flex-col items-center w-full ">
                ...
                <div className=" font-inter h-[40rem] bg-white w-full -mt-[5rem] z-20 rounded-tl-[10rem] rounded-tr-[3rem] rounded-br-[10rem] rounded-bl-[3rem] shadow-lg flex items-center justify-center px-[8rem] text-center flex-col">
